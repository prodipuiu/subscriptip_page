...
if(isset($_POST['submit'])){
  ...
  $sql = "INSERT INTO package (package_name, payment_term, active_date, end_date,email)  VALUES('1- month package','$payment_term',CURRENT_DATE,ADDDATE(CURRENT_DATE, INTERVAL 10 DAY),'$email')";
